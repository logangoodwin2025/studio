                  ...
                  <div className="space-y-4 py-4">
                    ...
                    {uploadState === "success" && (
                       <Alert variant="default" className="border-green-500">
                         ...
                         <AlertDescription>
                           157 rows have been successfully validated and imported.
                         </AlertDescription>
                       </Alert>
                    )}
                    {uploadState === "error" && (
                       <Alert variant="destructive">
                         ...
                         <AlertDescription>
                            <p>3 errors found in your file. Please correct them and try again.</p>
                            <ul className="mt-2 list-disc list-inside text-xs">
                                <li>Row 15: Invalid 'revenueAmount'. Must be a number.</li>
                                <li>Row 42: 'invoiceDate' is not a valid date.</li>
                                <li>Row 88: Duplicate 'invoiceNumber' found.</li>
                            </ul>
                         </AlertDescription>
                       </Alert>
                    )}
